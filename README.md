...
by [Adam Yaxley](https://github.com/adamyaxley).
...
And then include `obfuscate.h` as follows:
```c
#include "node_modules/obfuscate.cxx/obfuscate.h"
```

## Quick start guide
1. Include `obfuscate.h` into your file
...
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/obfuscate.cxx)
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/adamyaxley/Obfuscate)
